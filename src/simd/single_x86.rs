//! Vendored x86_64 scalar compression (BSD-2-Clause).
//! Copyright (c) 2026, Latigo LLC. Source attribution and full license: NOTICE.
//! Assembly provenance: animetosho/md5-optimisation (PD/CC0). See NOTICE.
//!
